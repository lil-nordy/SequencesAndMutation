...
Authors: David Mutchler, Amanda Stouder, Chandan Rupakheti, Katie Dion,
         ...
         and Nathaniel Neil Nate Nordquist.
...
def RETURN_circle(circle, color):
    ...
    # THEN
    # circle.center.x += 5 ... this changes ???
    # These two statements are correct, but the first has better style because the names of the circle passed in as
    # an argument and the variable name in the function namespace are different.
